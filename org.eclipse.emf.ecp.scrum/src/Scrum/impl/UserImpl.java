...
public class UserImpl extends EObjectImpl implements User {
	...
	protected EClass eStaticClass() {
		return ScrumPackage.Literals.USER;
	}
	...
	public void setFirstName(String newFirstName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScrumPackage.USER__FIRST_NAME, oldFirstName, firstName));
	}
	...
	public void setLastName(String newLastName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScrumPackage.USER__LAST_NAME, oldLastName, lastName));
	}
