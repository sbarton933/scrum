...
public class ScrumSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ScrumPackage.TASK: {
				...
				if (result == null) result = caseBacklogItem(task);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScrumPackage.BUGREPORT: {
				...
				if (result == null) result = caseBacklogItem(bugreport);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ScrumPackage.BACKLOG: {
				...
				if (result == null) result = caseComposite(backlog);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ScrumPackage.SPRINT: {
				...
				if (result == null) result = caseComposite(sprint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bugreport</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bugreport</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
