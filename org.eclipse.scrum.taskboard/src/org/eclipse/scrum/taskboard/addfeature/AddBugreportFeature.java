package org.eclipse.scrum.taskboard.addfeature;
...
public class AddBugreportFeature extends AbstractAddShapeFeature{
	...
	public AddBugreportFeature(IFeatureProvider fp) {
		super(fp);
	}
